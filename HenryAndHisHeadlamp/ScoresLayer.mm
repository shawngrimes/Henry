...
//        [userIconSprite setScaleY:(size.height/768.0f) * 1.2];
    ...
    CCLOG(@"First: %f", [[firstPlace valueForKey:@"time"] floatValue]);
    CCLOG(@"Second: %f", [[secondPlace valueForKey:@"time"] floatValue]);    
    CCLOG(@"Third: %f", [[thirdPlace valueForKey:@"time"] floatValue]);
